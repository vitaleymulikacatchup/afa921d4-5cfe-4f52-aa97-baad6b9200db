...
export const metadata: Metadata = {
  ...
  description: "Cloudflare makes everything you connect to the Internet secure, private, fast, and reliable. Protect and accelerate any website, application, or team.",
  keywords: "CDN, web security, DDoS protection, DNS, serverless computing, web performance, cloud security",
  metadataBase: new URL("https://cloudflare.com"),
  alternates: {
    canonical: "https://cloudflare.com"
  },
  openGraph: {
    title: "Cloudflare - The Web Performance & Security Company",
    ...
    images: [{
      ...
      alt: "Cloudflare dashboard interface"
    }],
    type: "website"
  },
  twitter: {
